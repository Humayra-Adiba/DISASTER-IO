    ...
    <div>
      ...
      <div className='md:mx-80 mx-10 flex flex-col gap-4 mt-5'>
        <div className='w-full flex flex-col gap-2'>
          ...
          <input type="text" placeholder='Add title here' className='rounded-md p-3 border border-gray-200  w-full' style={{backgroundColor:"rgba(244, 244, 245, 1)"}} />
        </div>
        <div className='w-full flex flex-col gap-2'>
          ...
          <textarea name="text" rows="5" id="text" className='rounded-md p-3 border border-gray-200  w-full' placeholder='Type here' style={{backgroundColor:"rgba(244, 244, 245, 1)"}}></textarea>
        </div>
